...
const addHeaderComponent = (setHeadComponents, scriptProps, scriptEcommerceProps) => {
  ...
  if (scriptEcommerceProps && scriptEcommerceProps.trackEcommerce) {
    ...
    components.push(<script key="gatsby-plugin-vantevo-analytics-ecommerce" id="vantevo-analytics-ecommerce" {...scriptEcommerceProps}></script>)
...
exports.onRenderBody = ({ setHeadComponents }, pluginOptions) => {
  ...
  const { excludePath, dev, hash, domain, manualPageview, outboundLinks, trackFiles, saveExtensionFiles, scrScript, trackEcommerce, scrScriptEcommerce, proxyServer, proxyServerEcommerce } = pluginOptions;
